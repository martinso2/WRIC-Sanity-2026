export const socialLinks = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/womensrightsinfo/",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/womensrightscenter/",
    icon: (
      <svg aria-hidden="true" fill="currentColor" height="20" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/women%27s-rights-information-center",
    icon: (
      <svg aria-hidden="true" fill="currentColor" height="20" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
